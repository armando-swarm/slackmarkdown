...
type RendererOptions struct {
	...
	// Defaults (note content quote is not closed) to `  <meta name="GENERATOR" content="github.com/armando-swarm/slackmarkdown markdown processor for Go`
	Generator string
}
...
func NewRenderer(opts RendererOptions) *Renderer {
	...
	if opts.Generator == "" {
		opts.Generator = `  <meta name="GENERATOR" content="github.com/armando-swarm/slackmarkdown markdown processor for Go`
	}
