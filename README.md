...
- https://pkg.go.dev/github.com/armando-swarm/slackmarkdown : top level package
- https://pkg.go.dev/github.com/armando-swarm/slackmarkdown/ast : defines abstract syntax tree of parsed markdown document
- https://pkg.go.dev/github.com/armando-swarm/slackmarkdown/parser : parser
- https://pkg.go.dev/github.com/armando-swarm/slackmarkdown/html : html renderer
...
- **Safety**. Markdown is paranoid when parsing, making it safe
  ...
  [this example](https://github.com/armando-swarm/slackmarkdown#sanitize-untrusted-content).
...
Some tools using this package: https://pkg.go.dev/github.com/armando-swarm/slackmarkdown?tab=importedby
